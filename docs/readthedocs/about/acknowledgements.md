# Acknowledgements
The SAVIOUR project was initially developed at the [Simons Initiative for the Developing Brain, University of Edinburgh](https://www.sidb.org.uk/) by [Andrew Scott-George](https://www.sidb.org.uk/peter-kind/andrew-scott-george), based on the experience, ideas, and oversight of [Patrick Spooner](https://www.sidb.org.uk/peter-kind/patrick-spooner/) and the willingness of [Prof Peter Kind](https://www.sidb.org.uk/peter-kind/) to support those ideas. Major thanks go to the [Simons Foundation Autism Research Initiative (SFARI)](https://www.sfari.org/) for funding SIDB's research.
...
- [Tess Atkinson](https://sidb.org.uk/peter-kind/tess-atkinson/), who further supported the development of APA with experiental feedback and ideas
- [Will Farnsworth-Rowson](https://sidb.org.uk/peter-kind/william-farnworth-rowson), who helped retrofit and install SAVIOUR into a pipeline Ollybox
- [Andrew Sutherland](https://sidb.org.uk/peter-kind/andrew-sutherland/), who expertise enabled and accelerated the retrofit of Habitat with SAVIOUR modules
- Maja Skuza, who applied SAVIOUR cameras to 3D pose estimation and whose feedback and experience building dozens of cameras led to many improvements in their design
- [Marino Pagan](https://sidb.org.uk/marino-pagan/), whose boundless enthusiasm continues to propel SAVIOUR to new heights
- [Nuria Garcia-Font](https://sidb.org.uk/marino-pagan/nuria-garcia-font/), who applied SAVIOUR cameras and microphones to the prosocial task
- Lily Wang, who applied a modified acoustic startle SAVIOUR rig to exploring the effect of sound on seizure in rats and supported the development of the saviour-ephys pipeline tool
