  ...
  return (
    <div className="experiment-metadata-container">
      ...
      <div className="metadata-form-row">
        ...
        <input id="rat-id" value={metadata.rat_id} onChange={(e) => handleChange("rat_id", e.target.value)} />
      </div>
      <div className="metadata-form-row">
        <label htmlFor="strain">Strain</label>
        <input id="strain" value={metadata.strain} onChange={(e) => handleChange("strain", e.target.value)} />
      </div>
      <div className="metadata-form-row">
        <label htmlFor="batch">Batch</label>
        <input id="batch" value={metadata.batch} onChange={(e) => handleChange("batch", e.target.value)} />
      </div>
      <div className="metadata-form-row">
